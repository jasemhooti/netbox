...
(6, 'AUTO_PAYMENT_VERIFY', '{\"enabled\":\"off\",\"minutes\":30}');
");
...
$connection->query("CREATE TABLE `games` (
  ...
  `win_amount` int(255) DEFAULT 0,
  `result` varchar(50) NOT NULL,
  `date` int(255) NOT NULL,
  PRIMARY KEY (`id`)
)");

$connection->query("CREATE TABLE `game_settings` (
  `id` int(255) NOT NULL AUTO_INCREMENT,
  `type` varchar(50) NOT NULL,
  `value` text NOT NULL,
  PRIMARY KEY (`id`)
...
$connection->query("INSERT INTO `game_settings` (`type`, `value`) VALUES
('min_bet', '500'),
('max_bet', '5000000'),
('dice_multiplier', '6'),
('slot_multiplier', '10'),
